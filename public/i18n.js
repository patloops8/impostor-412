...
es: {
  ...
  guidelinesBody: 'Vas a jugar con desconocidos. Tratá a los demás con respeto: nada de insultos, acoso ni contenido inapropiado en el chat. Podés reportar cualquier mensaje que rompa esta regla — los reportes los revisa el equipo de 412, y las cuentas que no respeten esto pueden quedar vetadas de las salas públicas.',
...
en: {
  ...
  guidelinesBody: "You're about to play with strangers. Treat others with respect: no insults, harassment, or inappropriate content in chat. You can report any message that breaks this rule — reports are reviewed by the 412 team, and accounts that don't follow this can be banned from public rooms.",
