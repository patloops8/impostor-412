...
es: {
  ...
  shareCardText: 'Mira mi tarjeta de 412 🏆',
  ...
  friendsBtn: '👥 Amigos',
  friendsTitle: '👥 Amigos',
  friendsYourCode: 'Tu código de amigo',
  friendsCopyCode: 'Copiar',
  friendsCodePlaceholder: 'Código de 6 caracteres',
  friendsAddBtn: 'Agregar',
  friendsIncomingTitle: 'Solicitudes recibidas',
  friendsListTitle: 'Tus amigos',
  friendsAccept: 'Aceptar',
  friendsDecline: 'Rechazar',
  friendsEmpty: 'Todavía no agregaste a ningún amigo. Comparte tu código o pide el de alguien más.',
  friendsOnline: 'En línea',
  friendsOffline: 'Desconectado',
  friendsRemove: 'Quitar amigo',
  friendsRemoveConfirm: '¿Quitar a esta persona de tu lista de amigos?',
  friendsEnterCode: 'Ingresa un código de 6 caracteres.',
  friendsRequestSent: '✓ Solicitud enviada',
  friendsError: 'No se pudo completar la acción. Intenta de nuevo.',
  inviteFriendsBtn: '📨 Invitar amigos',
  inviteFriendsTitle: '📨 Invitar amigos',
  inviteFriendsEmpty: 'Ninguno de tus amigos está en línea ahora mismo.',
  inviteFriendsSend: 'Invitar',
  inviteFriendsSent: '✓ Invitado',
  inviteFriendsSentToast: '✓ Invitación enviada',
  inviteAccept: 'Unirme',
  inviteDecline: 'Ignorar',
  inviteReceivedText: '{name} te invitó a jugar {game}',
  inviteReceivedTextNoGame: '{name} te invitó a jugar',
  inviteAlreadyInRoom: 'Ya estás en una sala. Sal de ahí antes de aceptar otra invitación.',
  albumBtn: '📕 Álbum',
  albumTitle: '📕 Álbum de estampas',
  albumOpenPacksBtn: '🎁 Abrir sobres',
  albumOfName: 'Álbum de {name}',
  albumBackBtn: '← Mi álbum',
  albumViewFriendBtn: 'Ver álbum',
  packsTitle: '🎁 Sobres',
  packStickersDesc: '{n} estampas por sobre',
  packNewSticker: '¡Nueva!',
  packOddsBtn: '📊 Ver probabilidades',
  packOddsTitle: 'Probabilidades por sobre',
  packOpenFreeBtn: 'Abrir gratis (x{n})',
  albumExclusivesTitle: '⭐ Exclusivas',
  rewardsGotToast: 'ganaste {reward}',
  rewardsExclusiveToast: '¡También ganaste la estampa exclusiva "{name}"!',
  pointsEarnedToast: '🪙 +{amount} puntos',
...
en: {
  ...
  friendsYourCode: 'Your friend code',
  friendsCopyCode: 'Copy',
  friendsCodePlaceholder: '6-character code',
  friendsAddBtn: 'Add',
  friendsIncomingTitle: 'Incoming requests',
  friendsListTitle: 'Your friends',
  friendsAccept: 'Accept',
  friendsDecline: 'Decline',
  friendsEmpty: "You haven't added any friends yet. Share your code or ask for someone else's.",
  friendsOnline: 'Online',
  friendsOffline: 'Offline',
  friendsRemove: 'Remove friend',
  friendsRemoveConfirm: 'Remove this person from your friends list?',
  friendsEnterCode: 'Enter a 6-character code.',
  friendsRequestSent: '✓ Request sent',
  friendsError: "Couldn't complete the action. Try again.",
  inviteFriendsBtn: '📨 Invite friends',
  inviteFriendsTitle: '📨 Invite friends',
  inviteFriendsEmpty: 'None of your friends are online right now.',
  inviteFriendsSend: 'Invite',
  inviteFriendsSent: '✓ Invited',
  inviteFriendsSentToast: '✓ Invite sent',
  inviteAccept: 'Join',
  inviteDecline: 'Ignore',
  inviteReceivedText: '{name} invited you to play {game}',
  inviteReceivedTextNoGame: '{name} invited you to play',
  inviteAlreadyInRoom: "You're already in a room. Leave it before accepting another invite.",
  albumBtn: '📕 Album',
  albumTitle: '📕 Sticker album',
  albumOpenPacksBtn: '🎁 Open packs',
  albumOfName: "{name}'s album",
  albumBackBtn: '← My album',
  albumViewFriendBtn: 'View album',
  packsTitle: '🎁 Packs',
  packStickersDesc: '{n} stickers per pack',
  packNewSticker: 'New!',
  packOddsBtn: '📊 View odds',
  packOddsTitle: 'Odds by pack',
  packOpenFreeBtn: 'Open free (x{n})',
  albumExclusivesTitle: '⭐ Exclusives',
  rewardsGotToast: 'you won {reward}',
  rewardsExclusiveToast: 'You also won the exclusive sticker "{name}"!',
  pointsEarnedToast: '🪙 +{amount} points',
