...
es: {
  ...
  roomGoneMsg: 'Esa sala ya no existe o la partida terminó. Creá una nueva o unite a otra.',
  ...
  contactIntro: '¿Encontraste un bug o tenés una sugerencia? Contanos.',
  contactTypeBug: 'Bug',
  contactTypeSuggestion: 'Sugerencia',
  contactTypeOther: 'Otro',
  contactPlaceholder: 'Contanos qué pasó...',
  contactOptional: 'Tu email o usuario (opcional)',
  contactSend: 'Enviar',
  contactEmptyError: 'Escribí un mensaje antes de enviar.',
