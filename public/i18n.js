...
es: {
  ...
  achFirstGameTitle: 'Primera partida',
  achFirstGameDesc: 'Juega tu primera partida',
  achFirstWinTitle: 'Primera victoria',
  achFirstWinDesc: 'Gana tu primera partida',
  achFrequentTitle: 'Jugador frecuente',
  achFrequentDesc: 'Juega 10 partidas en total',
  achVeteranTitle: 'Veterano',
  achVeteranDesc: 'Juega 50 partidas en total',
  achAllrounderTitle: 'Todoterreno',
  achAllrounderDesc: 'Juega los 5 juegos al menos una vez',
  achMasterImpostorTitle: 'Maestro del Impostor',
  achMasterImpostorDesc: 'Gana 5 partidas de El Impostor',
  achMasterSubastaTitle: 'Rey de la Subasta',
  achMasterSubastaDesc: 'Gana 5 partidas de Subasta Futbolera',
  achMasterMentirosoTitle: 'Mentiroso Profesional',
  achMasterMentirosoDesc: 'Gana 5 partidas de Mentiroso Futbolero',
  achMasterWavelengthTitle: 'Sintonía Perfecta',
  achMasterWavelengthDesc: 'Gana 5 partidas de La Frecuencia',
  achMasterWhoTitle: 'Detective',
  achMasterWhoDesc: 'Gana 5 partidas de ¿Quién Soy?',
  achLegendTitle: 'Leyenda',
  achLegendDesc: 'Gana 25 partidas en total',
  playAgain: '🔁 Jugar de nuevo',
  shareResultText: '🏆 {winner} ganó en {game} jugando 412! ¿Te animás a superarlo? {url}',
  shareCopied: '✓ Copiado',
...
en: {
  ...
  byGameTitle: 'By game',
  achFirstGameTitle: 'First game',
  achFirstGameDesc: 'Play your first match',
  achFirstWinTitle: 'First win',
  achFirstWinDesc: 'Win your first match',
  achFrequentTitle: 'Regular player',
  achFrequentDesc: 'Play 10 matches total',
  achVeteranTitle: 'Veteran',
  achVeteranDesc: 'Play 50 matches total',
  achAllrounderTitle: 'All-rounder',
  achAllrounderDesc: 'Play all 5 games at least once',
  achMasterImpostorTitle: 'Impostor Master',
  achMasterImpostorDesc: 'Win 5 matches of The Impostor',
  achMasterSubastaTitle: 'Auction King',
  achMasterSubastaDesc: 'Win 5 matches of Football Auction',
  achMasterMentirosoTitle: 'Professional Liar',
  achMasterMentirosoDesc: 'Win 5 matches of Football Liar',
  achMasterWavelengthTitle: 'Perfect Tuning',
  achMasterWavelengthDesc: 'Win 5 matches of Wavelength',
  achMasterWhoTitle: 'Detective',
  achMasterWhoDesc: 'Win 5 matches of Who Am I?',
  achLegendTitle: 'Legend',
  achLegendDesc: 'Win 25 matches total',
